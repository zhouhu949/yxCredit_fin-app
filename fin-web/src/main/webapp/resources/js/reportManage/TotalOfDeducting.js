    ...
    if(g_userManage.tableCustomer){
        ...
        g_userManage.tableCustomer = $('#sign_list').dataTable($.extend({
            ...
            "ajax" : function(data, callback, settings) {//ajax配置为function,手动调用异步查询
                ...
                Comm.ajaxPost('reportManage/getTotalOfDeductingList', JSON.stringify(queryFilter), function (result) {
                    //封装返回数据
                    debugger
                    var returnData = {};
            ...
            "columns": [
                ...
                {"data": "companyName","orderable" : false},//公司简称  机构名称
                {"data": "total","orderable" : false},//次数
            ],
