    ...
    if(g_userManage.tableCustomer){
        ...
        g_userManage.tableCustomer = $('#sign_list').dataTable($.extend({
            ...
            "ajax" : function(data, callback, settings) {//ajax配置为function,手动调用异步查询
                ...
                Comm.ajaxPost('reportManage/getThirdpartyData', JSON.stringify(queryFilter), function (result) {
                    //封装返回数据
                    debugger
                    var returnData = {};
            ...
            "columns": [
                ...
                {"data": "name","orderable" : false},//公司简称  机构名称
                {"data": "address","orderable" : false},//公司地址
