...
$(function (){
    g_userManage.tableUser = $('#afterLoanTable').dataTable($.extend({
        ...
        "ajax" : function(data, callback, settings) {//ajax配置为function,手动调用异步查询
            ...
            Comm.ajaxPost('afterLoan/listTelephone', JSON.stringify(queryFilter), function (result) {
                console.log(result);
                //封装返回数据
                var returnData = {};
        ...
        "columns": [
            ...
            {"data": "entrance_examination_date","orderable" : false,
                "render": function (data, type, row, meta) {
            ...
            {"data": "electronic_examination_state","orderable" : false,
                "render": function (data, type, row, meta) {
                    if(data.toString()=="1"){
                        return "进行中";
                    }else {
        ...
        "createdRow": function(row, data, index, settings, json) {
            ...
            var collectionbtn = $('<a href="##" style="text-decoration:none;color: #307ecc;" class="tabel_btn_style" onclick="collection(\''+data.customerId+'\')"> 外访分配</a>');
