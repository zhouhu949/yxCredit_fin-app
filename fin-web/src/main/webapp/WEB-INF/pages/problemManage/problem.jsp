...
<head>
    ...
    <script src="${ctx}/resources/js/problemManage/problem.js${version}"></script>
    ...
    <div class="commonManager">
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li><label class="lf">问题标题</label>
                    <label>
                        <input name="problem_name" type="text" class="text_add"/>
                    </label>
                </li>
        ...
        <div id="Add_procedure_style" style="display: none" >
            <div class="addCommon clearfix">
                <div>
                    ...
                    <ul>
                        <li>
                            <label class="lf">问题分类</label>
                            <label style="width: 173px">
                                <select id="problem_type" style="min-width:60px;height: 28px;">
                        ...
                        <li><label class="lf" >问题状态</label>
                            <label style="width: 173px;">
                                <select id="problem_state" style="min-width:60px;height: 28px;">
                                    <option value="">请选择</option>
                        ...
                        <li>
                            <label class="lf">问题标题</label>
                            <label>
                                <input id="problem_name" type="text" class="text_add"/>
                            </label>
                        </li>
                        <li style="width: 300px">
                            <label class="lf" style="margin-top: 20px;">问题描述</label>
                            <label style="width: 200px">
                                <textarea id="problem_desc" style="width: 245px;height: 75px;margin-left: 24px;margin-top: 12px;"></textarea>
                            </label>
                        </li>
                        <li style="width: 300px">
                            <label class="lf" style="margin-top: 100px;">问题答案</label>
                            <label style="width: 200px">
                                <textarea id="problem_content" style="width: 245px;height: 150px;margin-left: 24px;margin-top: 64px;"></textarea>
                            </label>
                        </li>
                    </ul>
                </div>
