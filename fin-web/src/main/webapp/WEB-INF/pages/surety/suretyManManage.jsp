...
<head>
    ...
    <script src="${ctx}/resources/js/surety/suretyManManage.js${version}"></script>
    ...
    <div class="commonManager">
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li style=" width: 300px;"><label class="lf">担保人姓名:</label>
                    <label>
                        <input  id="search_name" type="text" class="text_add"/>
                    </label>
                </li>
                <li style=" width: 300px;"><label class="lf">担保人手机号:</label>
                    <label>
                ...
                <li style="width:400px;">
                    ...
                    <button id="btn_add" type="button" class="btn btn-primary queryBtn">新增担保人</button>
                </li>
            </ul>
        </div>
        ...
        <%--添加弹出框--%>
        <div id="add_surety" style="display: none" >
            <div class="addCommon clearfix">
                <div>
                    <ul>
                        <li style="margin-left: 30px;margin-bottom: 10px;">
                            <label class="lf">担保人关系&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <label>
                                <select id="add_relation" class="if" style="width:150px;height: 33px;">
                                    <option value="" style="">请选择</option>
                                </select>
                            </label>
                        </li>
                        <li style="margin-left: 30px;margin-bottom: 10px;">
                            <label class="lf">担保人姓名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <label>
                                <input id="add_name" type="text" class="text_add" style="width:150px;height: 28px;" />
                            </label>
                        </li>
                        <li style="margin-left: 30px;margin-bottom: 10px;">
                            <label class="lf">担保人手机号&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <label>
                                <input id="add_tel" type="text" class="text_add" style="width:150px;height: 28px;" />
                            </label>
                        </li>
                        <li style="margin-left: 30px;margin-bottom: 10px;">
                            <label class="lf">担保人身份证号</label>
                            <label>
                                <input id="add_idcard" type="text" class="text_add" style="width:150px;height: 28px;" />
                            </label>
                        </li>
                        <li style="margin-left: 30px;margin-bottom: 10px;">
                            <label class="lf">担保人备注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <label>
                                <input id="add_remark" type="text" class="text_add" style="width:150px;height: 28px;" />
                            </label>
                        </li>
                    </ul>
                </div>
        ...
        <%--查看担保人担保的订单--%>
        <div class="Manager_style" style="display: none ;overflow: hidden;" id="surety_order_list_div">
                    <label style=" margin-left: 50px; margin-top: 20px;margin-bottom: 15px; float: left;">
                            <label>
                                客户姓名：<input  id="customerName" type="text" class="text_add"/>
                            </label>
                            <label>
                                &nbsp;&nbsp;&nbsp;客户手机号：<input  id="tel" type="text" class="text_add"/>
                            </label>
                            <label>
                                <button id="btn_search_order" type="button" class="btn btn-primary queryBtn">查询</button>
                            </label>
                            <label>
                                <button id="btn_search_order_reset" type="button" class="btn btn-primary queryBtn">查询重置</button>
                            </label>
                    </label>
            <div class="order_list">
                <table style=" clear:both ;cursor:pointer; font-size: 10px; width: 1000px; margin-left: 50px;margin-top: 10px;" id="surety_order_list" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>序号</th>
                        <th>订单编号</th>
        ...
        <%--担保按钮弹出框--%>
        <div class="Manager_style" style="display: none ;overflow: hidden;" id="danbao_surety_order_list_div">
            <label style=" margin-left: 50px; margin-top: 20px;margin-bottom: 15px; float: left;">
                <label>客户姓名：<input type="text" id="danbao_content_surety_order_name" class="text_add" style="width: 150px;height: 28px"></label>
                <label>客户手机号：<input type="text" id="danbao_content_surety_order_tel" class="text_add" style="width: 150px;height: 28px"></label>
                <button id="btn_search_order_danbao" type="button" class="btn btn-primary queryBtn">查询</button>
                <button id="btn_search_order_danbao_reset" type="button" class="btn btn-primary queryBtn">查询重置</button>
            </label>
            <div class="order_list">
                <table style=" clear:both ;cursor:pointer; font-size: 10px; width: 1000px; margin-left: 50px;margin-top: 10px;" id="danbao_surety_order_list" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>序号</th>
                        <th>订单编号</th>
