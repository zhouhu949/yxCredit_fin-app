...
<head>
    ...
    <script src="${ctx}/resources/js/messageManage/message.js${version}"></script>
    ...
    <div class="commonManager">
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li><label class="lf">消息标题</label>
                    <label>
                        <input name="message_name" type="text" class="text_add"/>
                    </label>
                </li>
        ...
        <div id="Add_procedure_style" style="display: none" >
            <div class="addCommon clearfix">
                <div>
                    ...
                    <ul>
                        <li>
                            <label class="lf">消息类型</label>
                            <label style="width: 173px">
                                <select id="message_type" style="min-width:60px;height: 28px;">
                                    <option value="">请选择</option>
                                </select>
                            </label>
                        </li>
                        <li>
                            <label class="lf">消息标题</label>
                            <label>
                                <input id="message_name" type="text" class="text_add"/>
                            </label>
                        </li>
                        <%--<li style="width: 300px">--%>
                            <%--<label class="lf" style="margin-top: 20px;">消息描述</label>--%>
                            <%--<label style="width: 200px">--%>
                                <%--<textarea id="message_desc" style="width: 245px;height: 75px;margin-left: 24px;margin-top: 12px;"></textarea>--%>
                            <%--</label>--%>
                        <%--</li>--%>
                        <li ><label class="lf" >消息状态</label>
                            <label style="width: 173px;">
                                <select id="message_state" style="min-width:60px;height: 28px;">
                                    <%--<option value="">请选择</option>--%>
                        ...
                        <li style="width: 300px">
                            <label class="lf" style="margin-top: 15px;">消息内容</label>
                            <label style="width: 200px">
                                <textarea id="message_content" style="width: 450px;height: 150px;margin-left: 24px;margin-top: 20px;"></textarea>
                            </label>
                        </li>
                    </ul>
                </div>
