...
<head>
    ...
    <script src="${ctx}/resources/js/systemMange/AppDict_Ctrl.js${version}"></script>
    <title>App字典管理</title>
    <style type="text/css">
...
<div class="page-content" style="height:100%;padding:0;">
   <div id="content" style="width: 100%;float: right;height: 100%;overflow: auto;">
    ...
    <form name="form" id="myForm" method="post">
            ...
            <div class="commonManager ">
                <div class="addCommon">
                    ...
                    <div class="Remark" style="padding-top: 20px;">
                        <label class="label_name">备注</label>
                        <label>
                            <textarea name="remark" id="desc" cols="" rows="" style="width: 456px; height: 100px; padding: 5px;"></textarea>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <input type='hidden' id='dictNames'>
