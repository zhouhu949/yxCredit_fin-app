...
<head>
    ...
    <script src="${ctx}/resources/js/reclaimMerchant/reclaimMerchant.js${version}"></script>
    ...
    <style type="text/css">
        ...
        #addMerchantNew .items{
            text-align: left;
            margin: 20px;
        }
        #addMerchantNew .itemsLabel{
            text-align: right;
            display: inline-block;
            width: 30%;
            padding-right: 20px;
        }
        #addMerchantNew .itemsContent{
            display: inline-block;
            width: 65%;
            position: relative;
        }
    ...
    <div class="commonManager">
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li style=" width: 300px;"><label class="lf">商户名称:</label>
                    <label>
                        <input  id="search_merName" type="text" class="text_add"/>
                    </label>
                </li>
                ...
                <li style="width:400px;">
                    ...
                    <button id="btn_add" type="button" class="btn btn-primary queryBtn">新增商户</button>
                </li>
            </ul>
        </div>
        ...
        <%----------------------------------------------------------------------------------------------------------------%>
        <div id="addMerchantNew" style="display: none">
            <div class="items">
                <label for="depId" class="itemsLabel">
                    分公司
                </label>
                <span class="itemsContent">
                    <select id="depId" class="if" style="width:100%;height: 33px;">
            ...
            <div class="items">
                ...
                <span class="itemsContent">
                    <input id="merName" type="text" class="text_add" style="width:100%;height: 28px;margin: 0" />
                </span>
            </div>
            <div class="items">
                <label for="depId" class="itemsLabel">
                ...
                <span class="itemsContent">
                    <select id="status" style="width:100%;height: 33px;">
            ...
            <div class="items">
                ...
                <span class="itemsContent">
                    <textarea id="merInfo" style="width: 100%;margin: 0"></textarea>
                </span>
            </div>
            <div class="items">
                <label for="depId" class="itemsLabel">
                ...
                <span class="itemsContent">
                    <input type="hidden" class="imgHidden" class="imgHidden" name="type" value="1">
                        <input type="hidden" class="imgHidden"  id="merLogo" name="src" value=""/>
                        <input type="hidden" class="imgHidden" name="originalName" value="">
                        <%--<input type="hidden" class="imgHidden" name="isfront" value="0">--%>
                        <form action="" enctype="multipart/form-data">
                            <div class="">
                                <input type="file"  name="pic" class="picShow" style="z-index:999" onchange="setImagePreview1(this)"/>
                                <img class="addMaterial"  id='img' src="${ctx}/resources/images/photoadd.png"/>
