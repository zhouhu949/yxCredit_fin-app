...
<head>
    ...
    <script src="${ctx}/resources/js/goldOrder/logisticsRecordList.js${version}"></script>
    <title>发货列表</title>
    <style>
            ...
            <table  cellpadding="0" cellspacing="0" class="table  table-bordered ">
                ...
                <tr>
                    ...
                    <td style="text-align: left;" >
                        <input name="billNo" id="purchasePrice" type="text" class="text_add" style="width: 140px;" MAXLENGTH="10"/><span>元/克</span>
                    </td>
