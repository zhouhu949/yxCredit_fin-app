...
<head>
    ...
    <script src="${ctx}/resources/js/couponManage/recommendList.js${version}"></script>
    ...
    <div class="commonManager">
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li  style="width: 270px"><label class="lf">渠道名称：</label>
                    <label>
                ...
                <li ><label class="lf">状态：&nbsp;&nbsp;</label>
                    <label>
                        <select id="state"class="text_add" style="width: 163px;height: 28px">
