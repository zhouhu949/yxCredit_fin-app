...
<head>
    ...
    <script src="${ctx}/resources/js/suggestion/suggestion.js${version}"></script>
            ...
            <ul class="search_content clearfix">
                ...
                <%--<li><label class="lf">类型</label>--%>
                    <%--<label style="width: 100px">--%>
                        <%--<select id="s_type" style="width:120px;height: 28px;margin-left: 10px;">--%>
