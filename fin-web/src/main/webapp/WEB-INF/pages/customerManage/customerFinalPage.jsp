                ...
                <div class="paddingBox xdproadd" style="width:1200px">
                    ...
                    <div class="paperBlockfree" id="pictureLoad">
                        ...
                        <table class="tb_info " style="font-size:12px;">
                            ...
                            <tr>
                                <td class="align" width="10%">订单类型:</td>
                                <td id="offline_order" width="23%">${order.offlineOrder == '1'?"线下":"线上"}</td>T
                                <td class="align" width="10%">选择方式:</td>
                                <td id="diy_type"width="23%">${order.diyType == '1'?'自定义':'自然月'}</td>
                                <td class="align" width="10%">每期天数:</td>
                                <td  width="23%" id="diy_days">${order.diyDays}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="align">商品串号码:</td>
                                <td id="tdMerchandiseCode">${order.merchandiseCode}</td>
                            ...
                            <tr>
                                <td class="align">办单员姓名:</td>
                                <td id="salesmanName"></td>
                                <td class="align" >办单员工号:</td>
                                <td id="salesmanNum" ></td>
                                <td class="align">商户地址:</td>
                                <td id="merAddress">${order.provinces}${order.city}</td>
                            </tr>
                            <tr>
                    ...
                    <%--设备信息--%>
                        ...
                        <%--人工审核信息--%><!--首付款 审核人 审核时间 审核结果 审核意见 -->
                        <c:choose>
                        <c:when test="${processApproveRecord != null}">
                        <div class="paperBlockfree" style="margin-top:20px">
                            <div class="block_hd" style="float:left;" onclick="shrink(this)">
                                <s class="ico icon-file-text-alt"></s><span class="bl_tit">审核信息</span>
                            </div>
                            <table class="tb_info " style="font-size:12px;">
                                <tbody id="checkMessage">
                                <tr>
                                    <td style="width: 15%">审核结果：</td>
                                    <td style="width: 35%">
                                        <span id="checkResult">
                                             <c:choose>
                                                 <c:when test="${processApproveRecord.result == '1'}">
                                                     通过
                                                 </c:when>
                                                 <c:otherwise>
                                                     拒绝
                                ...
                                <tr>
                                    <td >审核人：</td>
                                    <td >
                                        <span id="checkMan">${processApproveRecord.handlerName}</span>
                                    </td>
                                    <td >审核时间：</td>
                                    <td >
                                        <span id="">${processApproveRecord.commitTime}</span>
                                    </td>


                                    <%--<td style="width: 15%">审核人：</td>--%>
                                    <%--<td style="width: 18%">--%>
                                        <%--<span id="">${order.productTypeName}</span>--%>
                                    <%--</td>--%>
                                ...
                                <tr>
                                    <td >审核意见：</td>
                                    <td colspan="3">
                                        <span id="check_suggestion">${processApproveRecord.approveSuggestion}</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
