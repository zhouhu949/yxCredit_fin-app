...
<head>
    ...
    <script src="${ctx}/resources/js/customerManage/customerConnect.js${version}"></script>
            ...
            <div class="table_res_list">
                        ...
                        <td>
                            <div class="tb_toolBar toolBar_s1 b_1_1_0">
                                <ul id="topInfo">
                                    ...
                                    <li class="toolBar_col">
                                        <button id="changeAll" type="button" class="btn btn-primary" onclick="changeAll()">一键交接</button>
                                    </li>
                ...
                <table style="text-align: center;" id="Res_list" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th>客户id</th>
                        <th>
                            <input name="checkBox_All" id="checkBox_All" type="checkbox"  class="ace" isChecked="false" style="cursor:pointer;" />
...
<div id="addLinkUser" style="display: none;height: 600px;width:1000px;border-left:none;position:relative;padding:20px;padding-bottom:60px;">
    <div class="commonManager">
        <form id="form1" name="form1" method="post" action="">
            <div class="Manager_style add_user_info search_style" style="text-align: left;margin-bottom: 10px;">
                <span>账号：</span><input name="account"  type="text" class="text_add" style="height:30px;vertical-align: top;margin-right: 10px;"/><button id="btn_search1"  type="button" class="btn btn-primary">查询</button>
