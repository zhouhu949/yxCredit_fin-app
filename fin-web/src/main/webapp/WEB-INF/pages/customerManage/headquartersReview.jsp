...
<div class="page-content">
    ...
    <input type="hidden" name="answerState" id="answerState" value="${order.answerState}"/>
    <input type="hidden" name="orderId" id="taskNodeId" value=""/>
    <input type="hidden" name="orderId" id="salesmanId" value="${order.empId}"/>
                    ...
                    <div class="paperBlockfree" id="pictureLoad">
                        ...
                        <table class="tb_info " style="font-size:12px;">
                            ...
                            <tr>
                                ...
                                <td id="tdReferee"></td>
                                <td class="align">分期金额:</td>
                                <td id="fenqiJE">${(order.applayMoney+oder.fee)/order.periods}</td>
                            </tr>
                            <tr>
                                <td class="align">办单员姓名:</td>
                                <td id="salesmanName">${order.empId}</td>
        ...
        <form class="calculateQuotaDialogForm" action="">
            <div class="paddingBox" >
                <table class="nobor">
                    ...
                    <tr>
                        <td>首付金额:</td>
                        <td colspan="5" style="text-align: left;"> <input type="text" id="predictPrice" value="${order.predictPrice}"  />元</td>
                    </tr>
