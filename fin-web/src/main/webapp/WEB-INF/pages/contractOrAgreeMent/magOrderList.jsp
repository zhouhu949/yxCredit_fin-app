...
<head>
    ...
    <script src="${ctx}/resources/js/contractOrAgreeMent/magOrderList.js${version}"></script>
...
<div class="page-content">
    <div class="commonManager">
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li><label class="lf">客户名称</label>
                    <label>
                        <input name="customer_name" type="text" class="text_add"/>
                    </label>
                </li>
                <li><label class="lf">身份证号</label>
                    <label>
                        <input name="customer_card" type="text" class="text_add"/>
                    </label>
                </li>
        ...
        <div class="Manager_style" id="contractList" style="display: none">
            <div class="order_list">
                <table style="cursor:pointer;" id="contract_list" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>序号</th>
                        <th>合同编号</th>
