...
<head>
    ...
    <script src='${ctx}/resources/js/merchantManagement/merchantList.js${version}'></script>
        ...
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                ...
                <li style="width:250px;">
                    ...
                    <label >
                        <select name="condition" id="search_merchant_grade")
                    ...
                    <div class="paddingBox xdproadd" style="width:1200px">
                        <div class="paperBlockfree" style="margin-top:20px">
                            ...
                            <table class="tb_info " style="font-size:12px; color: #000;">
                                <tbody>
                                <tr>
                                    <td  style="width: 131px;">公司名称:</td>
                                    <td  style="width: 288px;">
                                        <input id='add_mer_name' type="text"  class="text_add" style="width: 250px;" placeholder="点击输入">
                                    </td>
                                    <td  width="131px">营业执照注册号:</td>
                                    <td width="23%" id="tdSex">
                                        <input id='add_license_number' type="text" class="text_add" style="height: 28px;width: 250px;"placeholder="点击输入" >
                                    </td>
                                    <td class="align" width="131px">主营业务:</td>
                                    <td id="proTel" width="23%">
                                        <input id="add_main_business" type="text" class="text_add" style="width: 250px; "placeholder="点击输入"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td id="applyCensus">
                                        <input id="add_registered_capital" type="text" class="text_add" style="width: 200px;"/>
                                        <span>/万元</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td id="tdBirth">
                                        <input id="add_employees_number" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                ...
                                <tr>
                                    <td>门店电话:</td>
                                    <td id="unitName">
                                        <input id="add_merchant_tel" type="text" class="text_add" style="width: 250px;"placeholder="点击输入"/>
                                    </td>
                                    <td class="align">详细地址:</td>
                                    <td id="education" colspan="1">
                                        <input id="add_merchant_detail_address" type="text" class="text_add" style="width: 250px;"placeholder="点击输入"/>
                                    </td>
                                    <td>门店邮箱:</td>
                                    <td >
                                        <input id="add_merchant_email" type="text" class="text_add" style="width: 250px;"placeholder="点击输入"/>
                                    </td>
                                </tr>
                            </table>
                            <%--申请人信息--%>
                            ...
                            <table class="tb_info " style="font-size:12px; color: #000;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="add_apply_name" type="text" class="text_add" style="width: 250px;"placeholder="点击输入"/>
                                    </td>

                                    <td style="width:131px;">申请人电话:</td>
                                    <td>
                                        <input id="add_apply_tel" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>

                                    <td style="width:131px;">申请人身份证号:</td>
                                    <td >
                                        <input id="add_apply_idcard" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="tb_info " style="font-size:12px; color: #000;" id="faren_table">
                                ...
                                <tr>
                                    <td width="131px;">法人姓名:</td>
                                    <td  width="288px;">
                                        <input id="add_person_name" type="text" class="text_add" style="width: 250px;"placeholder="点击输入" />
                                    </td>
                                    <td>法人电话:</td>
                                    <td>
                                        <input id="add_person_tel" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                    <td>法人身份证号:</td>
                                    <td>
                                        <input id="add_persion_card" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>法人银行卡号:</td><!--***************-->
                                    <td>
                                        <input id="add_persion_bank_account" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <span style="line-height:30px;">市&nbsp;</span>
                                        <input id="add_persion_opening_bank" type="text" class="text_add" style="width: 200px;" placeholder="输入开户行名"/>
                                    </td>
                                </tr>
                                <%--总行名称 如：建设银行--%>
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <select  style="width: 250px; height: 31px; margin-left: -770px;" id="add_persion_opening_bank_head">
                                            <option val="">请选择</option>
                                        </select>
                                    </td>
                                </tr>
                            ...
                            <table class="tb_info " style="font-size:12px; color: #000;" id="add_money_bailor_table">
                                ...
                                <tr>
                                    <td style="width: 131px;">收款委托人姓名:</td>
                                    <td>
                                        <input id="add_money_bailor_name" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                    <td>收款委托人电话:</td>
                                    <td>
                                        <input id="add_money_bailor_tel" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                    <td>收款委托人身份证号:</td>
                                    <td>
                                        <input id="add_money_bailor_idcard" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>收款委托人银行卡号:</td>
                                    <td>
                                        <input id="add_money_bailor_account" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                    <td>收款委托人开户行:</td>
                                    <td colspan="3">
                                        ...
                                        <span style="line-height:30px;">市&nbsp;</span>
                                        <input id="add_money_bailor_oppen_bank" type="text" class="text_add" style="width: 200px;"placeholder="输入开户行名" />
                                    </td>
                                </tr>
                                <%--总行名称 如：建设银行--%>
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <select  style="width: 250px; height: 31px; margin-left: -786px;" id="add_money_bailor_oppen_bank_head">
                                            <option val="">请选择</option>
                                        </select>
                                    </td>
                                </tr>
                            ...
                            <table class="tb_info " style="font-size:12px; color: #000;" id="add_public_opening_table">
                                ...
                                <tr>
                                    <td style="width:131px;">对公账号名称:</td>
                                    <td>
                                        <input id="add_public_account_name" type="text" class="text_add" style="width: 250px; margin-left: -88px;" placeholder="点击输入"/>
                                    </td>
                                    <td>对公账号:</td>
                                    <td>
                                        <input id="add_public_bank_account" type="text" class="text_add" style="width: 250px;" placeholder="点击输入"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>对公开户行:</td>
                                    <td colspan="5">
                                        <select name="state" id="public_province" onchange="citySelAdd(this.options[this.options.selectedIndex].value,$('#public_city'))"type="text" style="width: 190px;height:30px;font-size: 14px; margin-left: -354px;" >
                                            <option value="">请选择</option>
                                        </select>
                                        <span style="line-height:30px;">省&nbsp;</span>
                                        ...
                                        <span style="line-height:30px;">市&nbsp;</span>
                                        <input id="add_public_opening_bank" type="text" class="text_add" style="width: 250px;" placeholder="输入开户行名"/>
                                    </td>
                                </tr>
                                <%--总行名称 如：建设银行--%>
                                <tr>
                                    ...
                                    <td colspan="5">
                                        <select  style="width: 250px; height: 31px; margin-left: -780px;" id="add_public_opening_bank_head">
                                            <option val="">请选择</option>
                                        </select>
                                    </td>
                                </tr>
                        ...
                        <div class="paperBlockfree" style="position: relative;margin-top:20px; text-align: left;">
                            ...
                            <button type="button" class="btn btn-primary queryBtn" style="width: 29%; display: inline; height: 40px;" id="submitAndCheck">提交审核</button>
                        </div>
                    </div>
                </div>
            </div>
