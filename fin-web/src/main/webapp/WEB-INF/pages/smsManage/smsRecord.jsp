...
<head>
    ...
    <script src="${ctx}/resources/js/smsManage/smsRecord.js${version}"></script>
        ...
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li><label class="lf">手机号码</label>
                    <label>
                        <input name="sms_tel" type="text" class="text_add"/>
                    </label>
                </li>
                <%--<li><label class="lf">创建时间</label>--%>
                    <%--&lt;%&ndash;<label>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<input readonly="true" placeholder="开始" class="eg-date" id="beginTime" type="text"/>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<span class="date-icon"><i class="icon-calendar"></i></span>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</label>&ndash;%&gt;--%>
                <%--</li>--%>
                <li style="width:260px;">
                <label>
                    <label class="lf">创建时间</label>
                ...
                <div>
                    ...
                    <ul>
                        <li>
                            ...
                            <label>
                                <input id="sms_tel" type="text"  readonly="readonly"/>
                            </label>
                        </li>
                        <li><label class="lf">发送时间</label>
                            <label>
                                <input id="create_time" type="text" readonly="readonly"/>
                            </label>
                        </li>
                        <li style="width: 300px">
                            <label class="lf">短信内容</label>
                            <label style="width: 200px">
                                <textarea id="sms_content" style="width: 200px;height: 200px;margin-left: 24px;margin-top: 12px;" readonly="readonly"></textarea>
                            </label>
                        </li>
                        </form>
                        </li>
