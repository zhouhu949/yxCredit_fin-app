...
<head>
    ...
    <script src="${ctx}/resources/js/afterLoan/extensionManagement.js${version}"></script>
    <title>展期管理</title>
    <style>
    ...
    <div class="commonManager">
        <div class="Manager_style add_user_info search_style">
            <ul class="search_content clearfix">
                <li><label class="lf">订单编号:</label>
                    <label>
                        <input name="customerName" id="orderNo" type="text" class="text_add"/>
                    </label>
                </li>
        ...
        <div class="Manager_style">
            <div class="order_list">
                <table style="cursor:pointer;" id="extensionTable" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th>序号</th>
                        <th>订单编号</th>
