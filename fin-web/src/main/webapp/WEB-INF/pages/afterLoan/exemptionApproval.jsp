...
<head>
    ...
    <script src="${ctx}/resources/js/afterLoan/exemptionApproval.js${version}"></script>
        ...
        <div id="settleDiv" style="display: none;padding: 1em;">
            <table  cellpadding="0" cellspacing="0" class="table  table-bordered ">
                ...
                <tr>
                    ...
                    <td style="text-align: left" colspan="3" id="lblFeeTdLab"><label id="lblFee"></label>元</td>
                    <td style="text-align: right;display: none" id="servicePackageAmountTdTab">服务包金额</td>
                    <td style="text-align: left;display: none" id="servicePackageAmountTdLab"><label id="servicePackageAmount"></label>元</td>
                </tr>
                <tr>
                    <td style="text-align: right">应还款额：</td>
                    <td   style="text-align: left" colspan="3"><label id="lblRepaymentAmount"></label>元
                ...
                <tr>
                    ...
                    <td   style="text-align: left">
                        <input name="reductionAmount" id="reductionAmount" type="text"  style="width: 60px" readonly="readonly" />元  <label id="lbl1" style="color:red;font-size:10px;"></label>
                    </td>
                </tr>
                <tr id="effectiveDataTr">
                    <td style="text-align: right">有效日期：</td>
                    <td style="text-align: left" colspan="3"><label id="effectiveDataLbl"></label></td>
                    </td>
                </tr>
                <tr><td colspan="4" style="text-align: left">审批详情</td></tr>
                <tr> <td style="text-align: right">审批结果：</td>
                    <td  colspan="3" style="text-align: left">
                        <label><input name="Fruit" type="radio" id="agree" checked="value" />同意 </label>
                        <label><input name="Fruit" type="radio" id="agree1" value="" />拒绝 </label>
            ...
            <div id="loanInfo" style="display: none">
                <div class="paddingBox xdproadd" style="width:920px">
                    ...
                    <%--<div class="paperBlockfree">--%>
                        ...
                        <%--</div>--%>
                        <%--<table class="tb_info" style="font-size:12px;display: none" id="wageEarner" hidden>&lt;%&ndash;--工薪者-&ndash;%&gt;--%>
                            <%--<tbody>--%>
                            <%--<tr>--%>
                            ...
                            <%--</tbody>--%>
                        <%--</table>--%>
                        <%--<table class="tb_info" style="font-size:12px;display: none" id="operator" hidden>&lt;%&ndash;--经营者-&ndash;%&gt;--%>
                            <%--<tbody>--%>
                            <%--<tr>--%>
                                <%--<td class="tdTitle">职业归属:</td>--%>
                            ...
                            <%--</tbody>--%>
                        <%--</table>--%>
                        <%--<table class="tb_info" style="font-size:12px;display: none" id="professional" hidden>&lt;%&ndash;--自由职业者-&ndash;%&gt;--%>
                            <%--<tbody>--%>
                            <%--<tr>--%>
                                <%--<td class="tdTitle">职业归属:</td>--%>
                            ...
                            <%--</tbody>--%>
                        <%--</table>--%>
                        <%--<table class="tb_info" style="font-size:12px;display: none" id="readingStu" hidden>&lt;%&ndash;--在读学生-&ndash;%&gt;--%>
                            <%--<tbody>--%>
                            <%--<tr>--%>
                                <%--<td class="tdTitle">职业归属:</td>--%>
                            ...
                            <%--</tbody>--%>
                        <%--</table>--%>
                        <%--<table class="tb_info" style="font-size:12px;display: none" id="retiree" >&lt;%&ndash;--退休人员-&ndash;%&gt;--%>
                            <%--<tbody>--%>
                            <%--<tr>--%>
                                <%--<td class="tdTitle">职业归属:</td>--%>
